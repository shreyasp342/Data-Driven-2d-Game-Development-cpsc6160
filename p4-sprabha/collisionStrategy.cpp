...
void RectangularCollisionStrategy::draw() const {
  ...
  IOmod::
  getInstance().writeText("Strategy: Rectangular", 500, 30, textColor);
}
...
void MidPointCollisionStrategy::draw() const {
  ...
  IOmod::
  getInstance().writeText("Strategy: Distance", 500, 30, textColor);
}
...
void PerPixelCollisionStrategy::draw() const {
  ...
  IOmod::
  getInstance().writeText("Strategy: Per-Pixel ", 500, 30, textColor);
}
