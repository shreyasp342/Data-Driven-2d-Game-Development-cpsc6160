...
void Hud::drawPool(SDL_Renderer * const renderer, unsigned int bulletlistSize, unsigned int freelistSize){
  ...
  // background.r = gdata.getXmlInt("hud/Pool/hudColor/red");
  // background.g = gdata.getXmlInt("hud/Pool/hudColor/green");
  // background.b = gdata.getXmlInt("hud/Pool/hudColor/blue");
  // background.a = gdata.getXmlInt("hud/Pool/hudColor/alpha");
